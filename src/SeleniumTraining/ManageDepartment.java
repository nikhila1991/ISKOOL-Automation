...
public class ManageDepartment {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[contains(text(),'Manage Department')]")).click();
		System.out.println("Manage Department click Successful");
		driver.findElement(By.xpath("//span[.='Add Department']")).click();
		driver.findElement(By.xpath("//input[@id='create-department_name']")).sendKeys("Department of Intermediate Education");
